...
export const aroundYouCopy = {
  en: {
    ...
    searchPlaces: "Search places, areas or categories",
    searchResults: "Matching places",
    noSearchResults: "No matching local places yet.",
    ...
    testModeDescription:
      "Use the tablet GPS or simulate a Utah location. This panel is not shown to passengers.",
  ...
  es: {
    ...
    searchPlaces: "Busca lugares, zonas o categorías",
    searchResults: "Lugares coincidentes",
    noSearchResults: "Aún no hay lugares locales coincidentes.",
    ...
    testModeDescription:
      "Usa el GPS de la tablet o simula una ubicación de Utah. Este panel no se muestra a pasajeros.",
