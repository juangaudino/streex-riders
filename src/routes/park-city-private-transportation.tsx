...
const page = LOCATION_PAGES["park-city-private-transportation"];
const canonical = `https://rides.getstreex.com/${page.slug}`;

export const Route = createFileRoute("/park-city-private-transportation")({
            ...
            "@graph": [
              {
                ...
                url: canonical,
                areaServed: ["Park City", "Salt Lake City", "Salt Lake City International Airport"],
                provider: {
  ...
  component: ParkCityPrivateTransportationRoute,
});

function ParkCityPrivateTransportationRoute() {
