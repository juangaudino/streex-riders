...
const page = LOCATION_PAGES["slc-airport-private-rides"];
const canonical = `https://rides.getstreex.com/${page.slug}`;

export const Route = createFileRoute("/slc-airport-private-rides")({
            ...
            "@graph": [
              {
                ...
                url: canonical,
                areaServed: ["Salt Lake City", "Salt Lake City International Airport", "Park City"],
                provider: {
  ...
  component: SLCPrivateRidesRoute,
});

function SLCPrivateRidesRoute() {
